...
dist(restaurante,cliente2,20).
dist(restaurante,cliente3,20).
dist(restaurante,cliente4,7).
dist(restaurante,cliente5,11).
dist(cliente1,cliente2,5).
dist(cliente1,cliente3,20).
dist(cliente1,cliente4,5).
dist(cliente1,cliente5,5).
dist(cliente2,cliente3,3).
dist(cliente2,cliente4,2).
dist(cliente2,cliente5,2).
dist(cliente3,cliente4,4).
dist(cliente3,cliente5,5).
dist(cliente4,cliente5,20).
